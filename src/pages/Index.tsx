...
export default function Index() {
  ...
  const faqs = [
    ...
    {
      question: 'Нужно ли приносить эскиз?',
      answer: 'Да, для работы нужен готовый эскиз. Вы можете найти понравившийся дизайн в интернете или у других мастеров. Я воплощу выбранную идею качественно и аккуратно на вашей коже.'
    },
    {
